...
def gameloop():
    ...
    global start_time, opponentHitCounter, won, overheat, shieldHits, playerHit, MoveX, shield_out, shieldOffTime, hitTime2, opponentHitTime2
    while True:
        end_time=time.perf_counter()
        if 1/(end_time-start_time) < 500:
...
def Restart():
    ...
    pygame.font.init()
    score="00000000"
    zig=pygame.font.Font(r"zig.ttf", 30)
    zigtxt=zig.render(score, False, (255, 255, 255))
    zigWidth=zigtxt.get_width()
    zigHeight=zigtxt.get_height()
    win=pygame.font.Font(r"zig.ttf", 72)
